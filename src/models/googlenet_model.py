# src/models/googlenet_model.py
from models.train_model import ModelTrainer

class GoogLeNetModelTrainer(ModelTrainer):
    ...
    def initialize_model(self):
        self.model = GoogLeNet(input_shape=self.input_shape, num_classes=self.num_classes)  # Uwaga: nie ma tutaj wag z ImageNet, GoogLeNet nie jest dostępne w modelach pre-trenowanych w Keras.
