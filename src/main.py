...
efficientnet_trainer = EfficientNetModelTrainer(input_shape=INPUT_SHAPE, epochs=EPOCHS)
efficientnet_trainer_no_imagenet = EfficientNetModelTrainer(input_shape=INPUT_SHAPE, use_imagenet=False, epochs=EPOCHS)
